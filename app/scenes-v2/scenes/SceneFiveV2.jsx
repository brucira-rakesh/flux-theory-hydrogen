...
const MODEL_MAIN_URL = "/models/Rebel_new_2-v1.glb";
const MODEL_SLABS_URL = "/models/Rebel_new_Stones_Slabs-v1.glb";
const TEXTURE_URL = "/textures/Rebel_New_Bake_2_etc1s.ktx2";
const SLATES_TEXTURE_URL = "/textures/Rebel_slates_etc1s.ktx2";
const BG_TEXTURE_URL = "/textures/Rebel_new_bg.ktx2";
