...
export type AboutPersonaProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  first: StorefrontAPI.Scalars['Int']['input'];
}>;

export type AboutPersonaProductsQuery = {
  products: {
    nodes: Array<
...
export type NavMenuQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
...
export type ShopCatalogQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
...
export type ProductSimilarQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  first?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['Int']['input']>;
}>;
...
> & {
  ...
  productDetails?: StorefrontAPI.Maybe<
  ...
  whyYoullLoveIt?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  suitableFor?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  stateOfMind?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  fragranceNotes?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  ...
  productTicker?: StorefrontAPI.Maybe<{
    references?: StorefrontAPI.Maybe<{
      nodes: Array<{
        feature?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
        >;
      }>;
    }>;
  }>;
  formulation?: StorefrontAPI.Maybe<{
    references?: StorefrontAPI.Maybe<{
      nodes: Array<{
        title?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
  ...
  dailyRoutine?: StorefrontAPI.Maybe<
  ...
  >;
  lifestyleBanner?: StorefrontAPI.Maybe<{
    reference?: StorefrontAPI.Maybe<{
      title?: StorefrontAPI.Maybe<Pick<StorefrontAPI.MetaobjectField, 'value'>>;
      description?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.MetaobjectField, 'value'>
      >;
      backgroundMedia?: StorefrontAPI.Maybe<{
        reference?: StorefrontAPI.Maybe<
          | {
              __typename:
                | 'Article'
      ...
      productShot?: StorefrontAPI.Maybe<{
        reference?: StorefrontAPI.Maybe<{
          image?: StorefrontAPI.Maybe<
            Pick<StorefrontAPI.Image, 'url' | 'altText' | 'width' | 'height'>
          >;
  ...
  product?: StorefrontAPI.Maybe<
    ...
    > & {
      ...
      allIngredients?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      whyYoullLoveIt?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      suitableFor?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      stateOfMind?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      fragranceNotes?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      howToUse?: StorefrontAPI.Maybe<{
        reference?: StorefrontAPI.Maybe<{
...
interface GeneratedQueryTypes {
  '#graphql\n  query AboutPersonaProducts(\n    $country: CountryCode\n    $language: LanguageCode\n    $first: Int!\n  ) @inContext(country: $country, language: $language) {\n    products(first: $first) {\n      nodes {\n        handle\n        title\n        featuredImage {\n          url\n          altText\n          width\n          height\n        }\n      }\n    }\n  }\n': {
    return: AboutPersonaProductsQuery;
    variables: AboutPersonaProductsQueryVariables;
  };
  ...
  '#graphql\n  query NavMenu(\n    $country: CountryCode\n    $menuHandle: String!\n    $language: LanguageCode\n  ) @inContext(language: $language, country: $country) {\n    menu(handle: $menuHandle) {\n      ...Menu\n    }\n  }\n  #graphql\n  fragment MenuItem on MenuItem {\n    id\n    resourceId\n    tags\n    title\n    type\n    url\n  }\n  fragment ChildMenuItem on MenuItem {\n    ...MenuItem\n  }\n  fragment ParentMenuItem on MenuItem {\n    ...MenuItem\n    items {\n      ...ChildMenuItem\n    }\n  }\n  fragment Menu on Menu {\n    id\n    items {\n      ...ParentMenuItem\n    }\n  }\n\n': {
    return: NavMenuQuery;
    variables: NavMenuQueryVariables;
  };
  ...
  '#graphql\n  query ShopCatalog(\n    $country: CountryCode\n    $language: LanguageCode\n    $handle: String!\n    $first: Int\n    $after: String\n  ) @inContext(country: $country, language: $language) {\n    collection(handle: $handle) {\n      id\n      handle\n      title\n      products(first: $first, after: $after) {\n        nodes {\n          id\n          handle\n          title\n          productType\n          tags\n          featuredImage {\n            id\n            url\n            altText\n            width\n            height\n          }\n          priceRange {\n            minVariantPrice {\n              amount\n              currencyCode\n            }\n          }\n          options {\n            name\n            optionValues {\n              name\n            }\n          }\n          variants(first: 20) {\n            nodes {\n              id\n              availableForSale\n              price {\n                amount\n                currencyCode\n              }\n              selectedOptions {\n                name\n                value\n              }\n            }\n          }\n          collections(first: 5) {\n            nodes {\n              handle\n              title\n            }\n          }\n          selectedOrFirstAvailableVariant {\n            id\n          }\n        }\n        pageInfo {\n          hasNextPage\n          endCursor\n        }\n      }\n    }\n  }\n': {
    return: ShopCatalogQuery;
    variables: ShopCatalogQueryVariables;
  };
  '#graphql\n  query ProductSimilar(\n    $country: CountryCode\n    $language: LanguageCode\n    $first: Int\n  ) @inContext(country: $country, language: $language) {\n    products(first: $first) {\n      nodes {\n        id\n        handle\n        title\n        productType\n        tags\n        featuredImage {\n          id\n          url\n          altText\n          width\n          height\n        }\n        priceRange {\n          minVariantPrice {\n            amount\n            currencyCode\n          }\n        }\n        options {\n          name\n          optionValues {\n            name\n          }\n        }\n        variants(first: 20) {\n          nodes {\n            id\n            availableForSale\n            price {\n              amount\n              currencyCode\n            }\n            selectedOptions {\n              name\n              value\n            }\n          }\n        }\n        collections(first: 5) {\n          nodes {\n            handle\n            title\n          }\n        }\n        selectedOrFirstAvailableVariant {\n          id\n        }\n      }\n    }\n  }\n': {
    return: ProductSimilarQuery;
    variables: ProductSimilarQueryVariables;
  };
